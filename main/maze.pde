...
int Maze::decide(int scenario)
{
  ...
  switch (scenario)
  {
    ...
    case 4:                                                                      //Special Case 8 Decision Making
        if (nextdead == true)
        { 
          cell[status.y - directy][status.x - directx].dead = true; //behind cell is dead 
          nextdead = false;
      ...
      break;
    default:
                                                                              /*Basic Decision Function Within Here:
                                                                                  -Use Sensor Values to Determine Walls in Current Cell
                                                                                  -Decides Action Based On Walls
                                                                                  -Goes to Mapping Case (In Global Interrupt)
